package com.kosen.reader.parsers.ksp
...
class ParserProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("com.kosen.reader.parsers.MangaSourceParser")
        ...
        val factoryFile =
            try {
                codeGenerator.createNewFile(
                    ...
                    packageName = "com.kosen.reader.parsers",
        ...
        val sourcesFile =
            try {
                codeGenerator.createNewFile(
                    dependencies = dependencies,
                    packageName = "com.kosen.reader.parsers.model",
    ...
    private fun writeContent(
        ...
        factoryWriter?.write(
			...
			import com.kosen.reader.parsers.core.MangaParserWrapper
