package com.kosen.reader.parsers.site.ru
...
@MangaSourceParser("MANGA_OVH_UPDATES", "Манга ОВХ (Обновления)", "ru")
internal class MangaOvhUpdatesParser(context: MangaLoaderContext) :
	PagedMangaParser(context, MangaParserSource.MANGA_OVH_UPDATES, 30),
