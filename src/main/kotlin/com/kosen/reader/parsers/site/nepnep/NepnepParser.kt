package com.kosen.reader.parsers.site.nepnep
...
import com.kosen.reader.parsers.util.json.mapJSONIndexed
...
internal abstract class NepnepParser(
	...
	override suspend fun getPages(chapter: MangaChapter): List<MangaPage> {
		...
		check(host.isNotEmpty()) {
			"Manga4Life is overloaded and blocking this app right now. Wait for unblock."
		}
