...
The following is a guide for creating Kosen parsers. Thanks for taking the time to contribute!
...
Kosen parsers are not a part of the Android application, but you can easily develop and test them directly inside an
Android application project and relocate it to the library project when done.

### Before you start

First, take a look at the `kosen-parsers` project structure. Each parser is a single class that
...
- [Example](https://github.com/Ithan-Cassiano/kosen-parsers/blob/master/src/main/kotlin/org/koitharu/kotatsu/parsers/site/ru/DesuMeParser.kt)
  of Json API usage.
- [Example](https://github.com/Ithan-Cassiano/kosen-parsers/blob/master/src/main/kotlin/org/koitharu/kotatsu/parsers/site/be/AnibelParser.kt)
  of GraphQL API usage
- [Example](https://github.com/Ithan-Cassiano/kosen-parsers/blob/master/src/main/kotlin/org/koitharu/kotatsu/parsers/site/en/MangaTownParser.kt)
...
Once the parser is ready you can relocate your code into the `kosen-parsers` library project in a `site` package and
...
- Run the `MangaParserTest` (`gradlew :test --tests "com.kosen.reader.parsers.MangaParserTest"`)
